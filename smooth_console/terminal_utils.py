...
"""
This is a section containing utilities for:
    - setting the cursor visibility
    - setting the cursor position
    - clearing the screen

For Windows, we use ctypes library  to perform it.
For Linux, we use ASCII Commands to perform it.

I don't know how the code in this section works completely as its more platform specific and c-based. 
"""
